        ...
        <div className="max-w-2xl w-full">
          ...
          <div className="mb-12">
            ...
            <div className="w-full h-px bg-white/10">
              <div
                className="h-full bg-[#FF9E7A] transition-[width] duration-[400ms] ease-in-out"
                  ...
                  {q[step].options.map((option, i) => {
                    ...
                    return (
                      <button
                        ...
                        style={isSelected ? { boxShadow: '0 0 1px 1px #FF9E7A' } : undefined}
                      >
                        <span
              ...
              <Reveal key={tier} delay={ti * 0.08} className="h-full">
                {isPopular ? (
                  ...
                  <div
                    ...
                    style={{ boxShadow: '0 14px 44px -8px rgba(255, 158, 122, 0.28)' }}
                  >
                    {inner}
                  </div>
                ) : (
