      ...
      <section className="relative z-10 py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex flex-col justify-between h-full">
                <div>
                  <div className="text-emerald-400 text-xs font-medium mb-3 uppercase tracking-wider">
                    {language === 'en' ? 'Discovery Phase' : 'Faza de Descoperire'}
                  </div>
                  <h3 className="text-lg lg:text-xl font-bold text-white mb-3 leading-tight">
                    {language === 'en' ? 'Understanding Your Vision' : 'Înțelegerea Viziunii Tale'}
                  </h3>
                  <p className="text-neutral-400 text-sm leading-relaxed">
                    {language === 'en' 
                      ? 'We dive deep into your business goals and requirements.'
                      : 'Intrăm în profunzime în obiectivele afacerii tale.'}
                  </p>
                </div>
                <div className="mt-4">
            ...
            {/* Card 2: Website Showcase (Center Large) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex flex-col h-full">
                <div className="text-center mb-6">
                  <div className="text-yellow-400 text-xs font-medium mb-2 uppercase tracking-wider">
                    {language === 'en' ? 'Premium Quality' : 'Calitate Premium'}
                  </div>
                  <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3">
                    {language === 'en' ? 'Websites that Convert' : 'Website-uri care Convertesc'}
                  </h2>
                  <p className="text-sm text-neutral-400 max-w-sm mx-auto">
                    {language === 'en' 
                      ? 'Professional designs optimized for performance'
                      : 'Designuri profesionale optimizate pentru performanță'}
                  </p>
                </div>
                ...
                <div className="flex-1 relative">
                  <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-xl p-4 border border-neutral-700 h-full">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center">
                        <span className="text-white font-medium text-sm">Your Website</span>
                      </div>
            ...
            >
              <div className="flex flex-col justify-between h-full">
                <div>
                  <div className="text-blue-400 text-xs font-medium mb-3 uppercase tracking-wider">
                    {language === 'en' ? 'Expert Team' : 'Echipă Expertă'}
                  </div>
                  <h3 className="text-lg lg:text-xl font-bold text-white mb-3 leading-tight">
                    {language === 'en' ? '5+ Years Experience' : '5+ Ani Experiență'}
                  </h3>
                  <p className="text-neutral-400 text-sm leading-relaxed">
                    {language === 'en' 
                      ? 'Specialized in modern web development.'
                      : 'Specializați în dezvoltarea web modernă.'}
                  </p>
                </div>
                <div className="mt-4">
                  <div className="text-2xl">🚀</div>
            ...
            {/* Card 4: Projects Count (Bottom Left) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="flex flex-col justify-between h-full">
                <div>
                  <div className="text-purple-400 text-sm font-medium mb-4 uppercase tracking-wider">
                    {language === 'en' ? 'Completed' : 'Finalizate'}
                  </div>
                  <h3 className="text-4xl lg:text-5xl font-bold text-white mb-2">50+</h3>
                  <h4 className="text-xl font-semibold text-white mb-4">
                    {language === 'en' ? 'Projects' : 'Proiecte'}
                  </h4>
                  <div className="flex items-center gap-2">
                    <Link href="/portfolio" className="text-purple-400 hover:text-purple-300 transition-colors text-sm font-medium flex items-center gap-1">
            ...
            >
              <div className="flex flex-col justify-between h-full">
                <div>
                  <div className="text-green-400 text-xs font-medium mb-3 uppercase tracking-wider">
                    {language === 'en' ? 'Ongoing Support' : 'Suport Continuu'}
                  </div>
                  <h3 className="text-lg lg:text-xl font-bold text-white mb-3 leading-tight">
                    {language === 'en' ? '24/7 Maintenance' : 'Mentenanță 24/7'}
                  </h3>
                  <p className="text-neutral-400 text-sm leading-relaxed">
                    {language === 'en' 
                      ? 'Dedicated support and regular updates.'
                      : 'Suport dedicat și actualizări regulate.'}
                  </p>
                </div>
                <div className="mt-4">
          ...
          >
            <Link href="https://wa.me/37368327082">
              <Button className="bg-gradient-to-r from-white to-neutral-100 hover:from-neutral-50 hover:to-neutral-200 text-black font-semibold px-8 py-4 text-lg rounded-2xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl relative z-20">
                {language === 'en' ? 'Start Your Project' : 'Începe Proiectul Tău'}
              </Button>
            </Link>
          </motion.div>
        </div>
