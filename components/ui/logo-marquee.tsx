...
const logos: { src: string, alt: string, h: string, treatment: Treatment, opacity?: string }[] = [
  ...
  { src: '/images/logos/cmiea.png', alt: 'CMIEA — cmiea.md', h: 'h-10 md:h-12', treatment: 'solid' },
  ...
  { src: '/images/logos/udc.png', alt: 'Universal Dental Clinic — udc.md', h: 'h-11 md:h-12', treatment: 'mono', opacity: 'opacity-50' },
...
const filters: Record<Treatment, React.CSSProperties> = {
  ...
  mono: { filter: 'grayscale(1) sepia(0.28) brightness(1.25) contrast(0.9)' },
}
